                ...
                <div className='flex flex-wrap justify-center items-center self-center'>
                    <div className='grid grid-cols-10 grid-rows-4 gap-3'>
                        ...
                        <LongBox description='Cybersécurité & Cloud Computing' row="row-start-1"
                                 col='col-start-5 col-end-8' clicked={() => {handleClicked('ccc')}}/>
                        <LongLogo src={'/3ds.svg'} col='col-start-8 col-end-10' row='row-start-1' clicked={() => {handleClicked('dassault')}}/>
                        ...
                        <ProjectBox col='col-start-2 col-end-4' row='row-start-1' description='Locations Projects' url={urls.locationsProject} />
                        <ProjectBox col='col-start-2 col-end-4' row='row-start-2' description='Docker TODO' url={urls.dockertodo}/>
                        ...
                        <LongBox col='col-start-8 col-end-10' row='row-start-4' description={card === 'me' ? 'déco' : 'retour' } clicked={() => {handleClicked('me')}}/>
                    </div>
